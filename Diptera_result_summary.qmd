...
chaoF       <- ChaoSpecies(diptera_wide$F ,"abundance", k = 2, conf = 0.95)        # trap F
...
# chaoSource <- ChaoSpecies(diptera_wide$Source ,"abundance", k = 2, conf = 0.95)   # trap Source
...
Trap_Source_diversity   <- Diversity(`Source`, "abundance", q = c(0, 1, 2))
