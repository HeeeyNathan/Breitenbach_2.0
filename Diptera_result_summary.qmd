...
tab_model(
  ...
  string.est = "Estimate",
  title = "Conditional Model Results for Overall Diptera Abundance",
  CSS = list(
    css.table = "width: 100%;",
...
tab_model(
  ...
  title = "Trap-specific Diptera Abundance Model Results",
  CSS = list(
    css.table = "width: 100%;",
    css.tdata = "padding: 3px;"
  )
...
tab_model(
  ...
  string.pred = "Predictor",
  string.est = "Estimate",
  title = "Conditional Model Results for Overall Diptera Species Richness",
  CSS = list(
    css.table = "width: 100%;",
    css.tdata = "padding: 3px;"
  )
...
tab_model(
  ...
  title = "Trap-specific Diptera Species Richness Model Results",
  CSS = list(
    css.table = "width: 100%;",
    css.tdata = "padding: 3px;"
  )
