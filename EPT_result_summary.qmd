...
# Save the plot
ggsave("Plots/EPT/EPT_abundance_model.png", width = 8, height = 7, dpi = 300, bg = "white")
```
...
# Save the plot
ggsave("Plots/EPT/EPT_sppRich_model.png", width = 8, height = 7, dpi = 300, bg = "white")
```
...
# Compare models using AIC
AIC(mod_poisson, mod_beta, mod_gaussian)
```
...
# Save the plot
ggsave("Plots/EPT/EPT_turnover_model.png", width = 8, height = 7, dpi = 300, bg = "white")
```
